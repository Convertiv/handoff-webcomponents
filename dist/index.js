...
var fetchComponent = function (componentId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, request.get("component/".concat(componentId, ".json"))];
            case 2:
                response = _a.sent();
...
var camelToDashCase = function (str) { return str.replace(/[A-Z]/g, function (letter) { return "-".concat(letter.toLowerCase()); }).replace(/^-/, ''); };
var buildTemplate = function (componentId) { return __awaiter(void 0, void 0, void 0, function () {
    var data, component, html, name, snakeName, template;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                html = (0, transpile_1.default)(component["code"]);
                name = componentId.replace(/_/g, " ").replace(/\b\w/g, function (c) { return c.toUpperCase(); }).replace(/\s/g, "");
                snakeName = camelToDashCase(name);
                template = "class ".concat(name, " extends HTMLElement {\n    constructor() {\n        super();\n        this.attachShadow({ mode: \"open\" });\n    }\n    connectedCallback() {\n        ").concat(Object.keys(component["properties"]).map(function (prop) {
                    var def = component["properties"][prop];
                    if (def.type === "array") {
                        return "let ".concat(prop, " = JSON.parse(this.getAttribute(\"data-").concat(camelToDashCase(prop), "\"));");
                    }
                    else {
                        return "let ".concat(prop, " = this.getAttribute(\"data-").concat(camelToDashCase(prop), "\");");
                    }
                }).join("\n"), "\n        this.shadowRoot.innerHTML = ` \n      <style>\n        ").concat(component["css"], "\n      </style>\n\n      ").concat(html, "\n    `;\n    }\n}\nwindow.customElements.define(\"").concat(snakeName, "\", ").concat(name, ");");
...
var writeToFile = function (template, id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        fs_1.default.writeFile("components/".concat(id, ".js"), template, function (err) {
            if (err) {
                console.error(err);
            }
        });
